    ...
    <Layout location={location} title={siteTitle}>
      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body speak">
          ...
          <p>When I have a great idea, I can't keep it to myself!</p>
          <p>
            Between client trainings and conference talks, I love to share some
            of the knowledge I've gained these past 15 years or so in the tech
            business. I am always looking for opportunities to speak -
            especially in tropical locations in winter (it's cold in Wisconsin)!
          </p>
          <p>
